...
public class BaseLocators {
    ...
    public static final String BUTTON_ACCEPT_COOKIES = "//button[@class='btn-black ml-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default']";
    public static final String BUTTON_WOMAN_CATEGORY = "(//a[@class='main__btn text-uppercase white--text text-center mr-12'])[1]";
